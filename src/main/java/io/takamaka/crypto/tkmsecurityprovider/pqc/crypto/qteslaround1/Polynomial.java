...
class Polynomial {
    ...
    /**
     * Size of the Signature Package (Z, C) (in Byte) for Heuristic qTESLA
     * Security Category-1. Z is A Polynomial Bounded by B and C is the Output
     * of A Hashed String
     */
    ...
    /**
     * Size of the Signature Package (Z, C) (in Byte) for Heuristic qTESLA
     * Security Category-3 (Option for Size). Z is A Polynomial Bounded by B and
     * C is the Output of A Hashed String
     */
    public static final int SIGNATURE_III_SIZE = (Parameter.N_III_SIZE * Parameter.D_III_SIZE + 7) / 8 + HASH;

    /**
     * Size of the Signature Package (Z, C) (in Byte) for Heuristic qTESLA
     * Security Category-3 (Option for Speed). Z is A Polynomial Bounded by B
     * and C is the Output of A Hashed String
     */
    public static final int SIGNATURE_III_SPEED = (Parameter.N_III_SPEED * Parameter.D_III_SPEED + 7) / 8 + HASH;

    /**
     * Size of the Signature Package (Z, C) (in Byte) for Provably-Secure qTESLA
     * Security Category-1. Z is A Polynomial Bounded by B and C is the Output
     * of A Hashed String
     */
    ...
    /**
     * Size of the Signature Package (Z, C) (in Byte) for Provably-Secure qTESLA
     * Security Category-3. Z is A Polynomial Bounded by B and C is the Output
     * of A Hashed String
     */
    public static final int SIGNATURE_III_P = (Parameter.N_III_P * Parameter.D_III_P + 7) / 8 + HASH;

    /**
     * Size of the Public Key (in Byte) Containing seedA and Polynomial T for
    ...
    /**
     * Size of the Private Key (in Byte) Containing Polynomials (Secret
     * Polynomial and Error Polynomial) and Seeds (seedA and seedY) for
     * Heuristic qTESLA Security Category-1
     */
    ...
    /**
     * **************************************************************************
     * Description:	Montgomery Reduction for Heuristic qTESLA Security Category
     * 1 and Security Category-3 (Option for Size and Speed)
     *
    ...
    /**
     * **************************************************************************
     * Description:	Montgomery Reduction for Provably-Secure qTESLA Security
     * Category-1 and Security Category-3
     *
     * @param number Number to be Reduced
     * @param q Modulus
     * @param qInverse
    ...
    /**
     * ***********************************************************************************************
     * Description:	Barrett Reduction for Provably-Secure qTESLA Security
     * Category-1 and Security Category-3
     *
     * @param number Number to be Reduced
     * @param barrettMultiplication
     ...
     * Security Category-1, Security Category-3 (Option for Size and Speed)
     *
    ...
    /**
     * ************************************************************************************************************
     * Description:	Forward Number Theoretic Transform for Provably-Secure
    ...
    /**
     * *********************************************************************************************************************************************************************************
     * Description:	Inverse Number Theoretic Transform for Provably-Secure
     * qTESLA Security Category-1
     *
     * @param destination Destination of Inverse Transformation
    ...
    /**
     * **************************************************************************************************************************************************
     * Description:	Component Wise Polynomial Multiplication for Heuristic
     * qTESLA Security Category-1 and Security Category-3 (Option for Size and
     * Speed)
     *
    ...
    /**
     * ****************************************************************************************************************************************************************************************************************
     * Description:	Component Wise Polynomial Multiplication for Provably-Secure
     * qTESLA Security Category-1 and Security Category-3
     *
     * @param product Product = Multiplicand (*) Multiplier
    ...
    /**
     * *********************************************************************************************************************************************
     * Description:	Polynomial Number Theoretic Transform for Provably-Secure
     * qTESLA Security Category-1 and Category-3
     *
    ...
    /**
     * *****************************************************************************************************************************************
     * Description:	Polynomial Multiplication for Heuristic qTESLA Security
     * Category-1 and Category-3 (Option for Size and Speed)
     *
     * @param product Product = Multiplicand * Multiplier
     * @param multiplicand Multiplicand Array
     * @param multiplier Multiplier Array
    ...
    /**
     * *************************************************************************************************************************************************************************************************
     * Description:	Polynomial Multiplication for Provably-Secure qTESLA
     * Security Category-1 and Category-3
     *
     * @param product Product = Multiplicand * Multiplier
     * @param productOffset Starting Point of the Product Array
     * @param multiplicand Multiplicand Array
    ...
    /**
     * **************************************************************************************************************************************************
     * Description:	Polynomial Addition for Heuristic qTESLA Security Category-1
     * and Category-3 (Option for Size or Speed) Q + L_E < 2 ^ (CEIL (LOGARITHM
     * (Q, 2))) No Necessary Reduction for Y + SC
     *
    ...
    /**
     * ******************************************************************************************************************************************************
     * Description:	Polynomial Addition for Provably-Secure qTESLA Security
     * Category-1 and Category-3 Q + L_E < 2 ^ (CEIL (LOGARITHM (Q, 2))) No
     * Necessary Reduction for Y + SC
     *
     * @param summation Summation = Augend + Addend
     ...
     * Security Category-1 and Category-3 (Option for Size or Speed) Q + L_E < 2
     * ^ (CEIL (LOGARITHM (Q, 2))) No Necessary Reduction for Y + SC
     *
     * @param summation Summation = Augend + Addend
     * @param augend Augend Array
     * @param addend Addend Array
    ...
    /**
     * *****************************************************************************************************************************************
     * Description:	Polynomial Subtraction with Montgomery Reduction for
     * Heuristic qTESLA Security Category-1 and Security Category-3 (Option for
     * Size or Speed)
     *
     * @param difference Difference = Minuend (-) Subtrahend
     * @param minuend Minuend Array
    ...
    /**
     * ****************************************************************************************************************************************************************************************************************************
     * Description:	Polynomial Subtraction for Provably-Secure qTESLA Security
     * Category-1 and Security Category-3
     *
     * @param difference Difference = Minuend (-) Subtrahend
    ...
    /**
     * ****************************************************************************************************************************************************************************
     * Description:	Generation of Polynomial A for Heuristic qTESLA Security
     * Category-1 and Security Category-3 (Option for Size or Speed)
     *
     ...
     * @param q Modulus
     * @param qInverse
     * @param qLogarithm q <= 2 ^ qLogarithm @param
     * generatorA
    ...
    /**
     * ************************************************************************************************************************************************************
     * Description:	Performs Sparse Polynomial Multiplication for A Value Needed
     * During Message Signification for Heuristic qTESLA Security Category-1 and
     ...
     * ***************************************************************************************************************************************************************************************************
     * Description:	Performs Sparse Polynomial Multiplication for A Value Needed
     * During Message Signification for Provably-Secure qTESLA Security
