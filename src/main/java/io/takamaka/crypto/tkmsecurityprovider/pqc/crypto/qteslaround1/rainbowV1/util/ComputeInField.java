 ...
 */
package io.takamaka.crypto.tkmsecurityprovider.pqc.crypto.qteslaround1.rainbowV1.util;

/**
 * This class offers different operations on matrices in field GF2^8.
 * <p>
 * Implemented are functions: - finding inverse of a matrix - solving linear
 * equation systems using the Gauss-Elimination method - basic operations like
 * matrix multiplication, addition and so on.
 */
public class ComputeInField {
     ...
     * @return inverse matrix of the input matrix. If the matrix is singular,
     * null is returned.
    ...
    public short[][] inverse(short[][] coef) {
        try {
            ...
            /**
             * Elimination operations to get the identity matrix from the left
             * side of A. *
             */
    ...
    /**
     * Elimination above the diagonal. This function changes a matrix so that it
     * contains only zeros above the diagonal(Ai,i) using only Gauss-Elimination
     * operations.
     * <p>
     * It is used in the inverse-function The result is stored in the global
     * matrix A
     * </p>
     *
     * @throws RuntimeException in case a multiplicative inverse of 0 is needed
    ...
    /**
     * This function multiplies two given matrices. If the given matrices cannot
     * be multiplied due to different sizes, an exception is thrown.
     *
     ...
     * <p>
     * An exception is thrown, if the number of columns in the matrix and the
     * number of rows in the one-dim. array differ.
     *
     ...
     * @throws RuntimeException in case the addition is impossible due to
