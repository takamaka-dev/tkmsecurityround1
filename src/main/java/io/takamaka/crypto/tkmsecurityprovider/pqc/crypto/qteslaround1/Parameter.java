...
final class Parameter {
    ...
    /**
     * Dimension, (Dimension - 1) is the Polynomial Degree for Heuristic qTESLA
     * Security Category-1
     */
    public static final int N_I = 512;

    /**
     * Dimension, (Dimension - 1) is the Polynomial Degree for Provably-Secure
    ...
    /**
     * Dimension, (Dimension - 1) is the Polynomial Degree for Heuristic qTESLA
     * Security Category-3 (Option for Speed)
     */
    ...
    /**
     * N_LOGARITHM = LOGARITHM (N) / LOGARITHM (2) for Heuristic qTESLA Security
     * Category-1
     */
    public static final int N_LOGARITHM_I = 9;

    /**
     * N_LOGARITHM = LOGARITHM (N) / LOGARITHM (2) for Provably-Secure qTESLA
     * Security Category-1
     */
    ...
    /**
     * N_LOGARITHM = LOGARITHM (N) / LOGARITHM (2) for Heuristic qTESLA Security
     * Category-3 (Option for Size)
     */
    public static final int N_LOGARITHM_III_SIZE = 10;

    /**
     * N_LOGARITHM = LOGARITHM (N) / LOGARITHM (2) for Heuristic qTESLA Security
     * Category-3 (Option for Speed)
     */
    ...
    /**
     * Q <= 2 ^ Q_LOGARITHM for Heuristic qTESLA Security Category-3 (Option for
     * Size)
     */
    ...
    /**
     * B Determines the Interval the Randomness is Chosen in During Signing for
    ...
    /**
     * B = 2 ^ B_BIT - 1 for Heuristic qTESLA Security Category-3 (Option for
     * Size)
     */
    ...
    /**
     * Number of Ring-Learning-With-Errors Samples for Heuristic qTESLA Security
     * Category-1
     */
    public static final int K_I = 1;

    /**
     * Number of Ring-Learning-With-Errors Samples for Provably-Secure qTESLA
     * Security Category-1
     */
    ...
    /**
     * Number of Non-Zero Entries of Output Elements of Encryption for Heuristic
     * qTESLA Security Category-1
     */
    public static final int H_I = 30;

    /**
     * Number of Non-Zero Entries of Output Elements of Encryption for
     * Provably-Secure qTESLA Security Category-1
     */
    ...
    /**
     * Number of Non-Zero Entries of Output Elements of Encryption for Heuristic
     * qTESLA Security Category-3 (Option for Size)
     */
    public static final int H_III_SIZE = 48;

    /**
     * Number of Non-Zero Entries of Output Elements of Encryption for Heuristic
     * qTESLA Security Category-3 (Option for Speed)
     */
    ...
    /**
     * Number of Rounded Bits for Heuristic qTESLA Security Category-3 (Option
     * for Size)
     */
    ...
    /**
     * Bound in Checking Error Polynomial for Heuristic qTESLA Security
     * Category-1
     */
    public static final int KEY_GENERATOR_BOUND_E_I = 1586;

    /**
     * Bound in Checking Error Polynomial for Provably-Secure qTESLA Security
     * Category-1
     */
    ...
    /**
     * Bound in Checking Secret Polynomial for Heuristic qTESLA Security
     * Category-1
     */
    public static final int KEY_GENERATOR_BOUND_S_I = 1586;

    /**
     * Bound in Checking Secret Polynomial for Provably-Secure qTESLA Security
     * Category-1
     */
    ...
    /**
     * Standard Deviation of Centered Discrete Gaussian Distribution for
     * Heuristic qTESLA Security Category-1
     */
    ...
    /**
     * XI = SIGMA * SQUARE_ROOT (2 * LOGARITHM (2) / LOGARITHM (e)) for
     * Heuristic qTESLA Security Category-1
     */
    ...
    /**
     * The Number of Blocks Requested in the First Extendable-Output Function
     * Call for Heuristic qTESLA Security Category-1
     */
    public static final int GENERATOR_A_I = 19;

    /**
     * The Number of Blocks Requested in the First Extendable-Output Function
     * Call for Provably-Secure qTESLA Security Category-1
     */
    public static final int GENERATOR_A_I_P = 108;

    /**
     * The Number of Blocks Requested in the First Extendable-Output Function
     * Call for Provably-Secure qTESLA Security Category-3 (Option for Size)
     */
    public static final int GENERATOR_A_III_SIZE = 38;

    /**
     * The Number of Blocks Requested in the First Extendable-Output Function
     * Call for Provably-Secure qTESLA Security Category-3 (Option for Speed)
     */
    public static final int GENERATOR_A_III_SPEED = 38;

    /**
     * The Number of Blocks Requested in the First Extendable-Output Function
     * Call for Provably-Secure qTESLA Security Category-3
     */
