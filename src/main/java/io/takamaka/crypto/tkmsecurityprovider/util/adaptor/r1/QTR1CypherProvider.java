...
public class QTR1CypherProvider {
    ...
    public static BCQTESLAPSSC1CypherBean sign(AsymmetricCipherKeyPair keyPair, String message) {
    ...
    public static BCQTESLAPSSC1CypherBean verify(AsymmetricCipherKeyPair keyPair, String signature, String message) {
        BCQTESLAPSSC1CypherBean tcb = new BCQTESLAPSSC1CypherBean();
        tcb.setValid(false);
    ...
    public static BCQTESLAPSSC1CypherBean verify(String publicKey, String signature, String message) {
        try {
