...
class Pack {
    ...
    /**
     * ***********************************************************************************************************************************************************
     * Description:	Encode Private Key for Heuristic qTESLA Security Category-3
     * (Option for Size)
     *
     * @param privateKey Private Key
     * @param secretPolynomial Coefficients of the Secret Polynomial
    ...
    /**
     * ***********************************************************************************************************************************
     * Description:	Decode Private Key for Heuristic qTESLA Security Category-3
     * (Option for Size)
     *
     * @param seed Kappa-Bit Seed
     * @param secretPolynomial Coefficients of the Secret Polynomial
    ...
    /**
     * ************************************************************************************************************************************************
     * Description:	Encode Public Key for Heuristic qTESLA Security Category-1
     * and Category-3 (Option for Size)
     *
    ...
    /**
     * ****************************************************************************************************************************************************
     * Description:	Encode Public Key for Heuristic qTESLA Security Category-3
     * (Option for Speed)
     *
     * @param publicKey Public Key
     * @param T T_1, ..., T_k
    ...
    /**
     * *****************************************************************************************************************************************************
     * Description:	Encode Public Key for Provably-Secure qTESLA Security
     * Category-1
     *
     * @param publicKey Public Key
     * @param T T_1, ..., T_k
    ...
    /**
     * **************************************************************************************************************************************
     * Description:	Decode Public Key for Heuristic qTESLA Security Category-1
     * and Category-3 (Option for Size)
     *
    ...
    /**
     * ***********************************************************************************************************************************************
     * Description:	Decode Public Key for Heuristic qTESLA Security Category-3
     * (Option for Speed)
     *
     * @param publicKey Decoded Public Key
     * @param seedA Seed Used to Generate the Polynomials A_i for i = 1, ..., k
    ...
    /**
     * **********************************************************************************************************************************************************
     * Description:	Decode Public Key for Provably-Secure qTESLA Security
     * Category-1
     *
     * @param publicKey Decoded Public Key
     * @param seedA Seed Used to Generate the Polynomials A_i for i = 1, ..., k
    ...
    /**
     * *************************************************************************************************************************************************************************************************************
     * Description:	Encode Signature for Heuristic qTESLA Security Category-1
     * and Category-3 (Option for Size)
     *
     * @param signature Output Package Containing Signature
     * @param signatureOffset Starting Point of the Output Package Containing
     * Signature
     * @param C
     * @param cOffset
     * @param Z
    ...
    /**
     * ***********************************************************************************************************************************************************************************************************
     * Description:	Encode Signature for Heuristic qTESLA Security Category-3
     * (Option for Speed)
     *
     * @param signature Output Package Containing Signature
     * @param signatureOffset Starting Point of the Output Package Containing
    ...
    /**
     * ***********************************************************************************************************************************************************************************************************
     * Description:	Encode Signature for Provably-Secure qTESLA Security
     * Category-1
     *
     * @param signature Output Package Containing Signature
     * @param signatureOffset Starting Point of the Output Package Containing
    ...
    /**
     * ****************************************************************************************************************************
     * Description:	Decode Signature for Heuristic qTESLA Security Category-1
     * and Category-3 (Option for Size)
     *
     * @param C
     * @param Z
    ...
    /**
     * ************************************************************************************************************************************
     * Description:	Decode Signature for Heuristic qTESLA Security Category-3
     * (Option for Speed)
     *
     * @param C
     * @param Z
    ...
    /**
     * **************************************************************************************************************************
     * Description:	Decode Signature for Provably-Secure qTESLA Security
     * Category-1
     *
     * @param C
     * @param Z
