...
import io.takamaka.crypto.tkmsecurityprovider.pqc.crypto.qteslaround1.rainbowV1.util.GF2Field;
import io.takamaka.crypto.tkmsecurityprovider.pqc.crypto.qteslaround1.rainbowV1.util.RainbowUtil;
...
public class Layer {
     ...
     *
     * @param x vinegar variables of this layer that should be plugged into the
     * polynomials.
