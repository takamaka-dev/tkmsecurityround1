...
/**
 * This class is needed for the conversions while encoding and decoding, as well
 * as for comparison between arrays of some dimensions
 */
public class RainbowUtil {
     ...
     *
     * @param in the array to be converted
     * @return out one-dimensional short-array that corresponds the input
     */
     ...
     * @return out short-matrix that corresponds the input
     */
    public static short[][] convertArray(byte[][] in) {
    ...
    /**
     * This function converts a 3-dimensional array of bytes into a
     * 3-dimensional array of type short
     *
     * @param in the array to be converted
     * @return out short-array that corresponds the input
     */
    public static short[][][] convertArray(byte[][][] in) {
     ...
     *
     * @param in the matrix to be converted
     * @return out the byte-matrix that corresponds the input
     */
    public static byte[][] convertArray(short[][] in) {
    ...
    /**
     * This function converts a 3-dimensional array of type short into a
     * 3-dimensional array of type byte
     *
     * @param in the array to be converted
     * @return out the byte-array that corresponds the input
     */
